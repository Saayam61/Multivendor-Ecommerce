...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/new4.jpg) no-repeat scroll center center / cover ;">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="categories.php?id=<?php echo 
                                  $get_product['0']['categories_id']; ?>"><?php echo 
                                  $get_product['0']['categories']; ?></a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                            <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.
                                            $get_product['0']['image']; ?>" alt="full-image">
                                        </div>
                                    </div>
                                </div>
